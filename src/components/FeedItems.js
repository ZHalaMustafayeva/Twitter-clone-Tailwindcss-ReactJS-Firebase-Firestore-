...
const FeedItem = ({
  ...
  return (
    <article className="flex space-x-3 border-b border-gray-extraLight px-4 py-3 cursor-pointer">
      <img src={avatar} alt="Profile" className="w-11 h-11 rounded-full object-cover" />
      <div className="flex-1">
        ...
        <ul className="-ml-1 mt-3 flex justify-between max-w-md">
          <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
            <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-primary2-light ">
              <ReplyIcon className="w-5 h-5 group-hover:text-primary2-base" />
            </div>
            <span className="group-hover:text-primary2-base">7</span>
          </li>
          ...
          <li className="flex items-center  space-x-3 text-gray-dark text-sm group">
            <div className="flex items-center justify-center w-8 h-8 rounded-full group-hover:bg-primary-light ">
              <ShareIcon className="w-5 h-5 group-hover:text-primary2-base" />
            </div>
          </li>
        </ul>
      </div>
